...
function Booking(props) {
  ...
  const newAppointment = (event) => {
    ...
    if (
      ...
      formData.append('datetime', form.datetime.value);
    ...
    <section className="booking">
      ...
      >
        <div className="booking__section">
          ...
          <div
            className="booking__container"
            phone-format="Please enter 10 digits of phone number"
            data-error="This field is required"
          >
        ...
        <div className="booking__section">
          ...
          >
            <select name="event" className="booking__input">
              <option value={props.location.state.event}>
                {props.location.state.event}
              </option>
              <option value={props.location.state.optionOne}>
                {props.location.state.optionOne}
              </option>
              <option value={props.location.state.optionTwo}>
                {props.location.state.optionTwo}
              </option>
            </select>
          ...
          <div
            className="booking__container"
            data-error="Please select the date and time"
          >
            <input
              className="booking__input"
              type="datetime-local"
          ...
          <label className="booking__label">
            Upload your photo with natural light
          </label>
          <div
            className="booking__container"
            data-error="Please upload a photo"
          >
